...
project = u'xbob.db.iris'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('xbob.db.iris')[0]
...
#html_short_title = 'xbob_db_iris_iris'
...
htmlhelp_basename = 'xbob_db_iris_iris_doc'
...
man_pages = [
    ('index', 'xbob_db_iris', u'Bob Database Support Documentation', [u'Idiap Research Institute'], 1)
]
